...
Full system architecture with 22 Mermaid diagrams is in [ARCHITECTURE.md](ARCHITECTURE.md) and the [GitHub Wiki](https://github.com/dranubhaparashar/Execution-Aware-VRP-Solver-and-Benchmark-Studio/wiki).
